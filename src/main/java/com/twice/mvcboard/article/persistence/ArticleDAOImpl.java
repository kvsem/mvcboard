package com.twice.mvcboard.article.persistence;

import com.twice.mvcboard.article.domain.ArticleVO;
...
public class ArticleDAOImpl implements ArticleDAO {
    ...
    private static final String NAMESPACE = "com.twice.mvcboard.mappers.article.ArticleMapper";
